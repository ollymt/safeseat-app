...
export default function SkeuoTabBar({ state, navigation }: any) {
    ...
    return (
        ...
        >
            <View pointerEvents="none" style={styles.stitchLine}>
                <Stitching color={Materials.stitch} style={{ borderWidth: 0, borderTopWidth: 1 }} />
            </View>
            <BrassRivet size={5} style={{ position: "absolute", top: 6, left: 10 }} />
            <BrassRivet size={5} style={{ position: "absolute", top: 6, right: 10 }} />
                    ...
                    return (
                        <Pressable key={route.key} onPress={onPress} style={styles.tabItem}>
                            ...
                            <Text
                                style={[
                                    styles.label,
                                    { color: isFocused ? "#F4ECD8" : Materials.stitchDim, fontWeight: isFocused ? "700" : "500" },
                                ]}
                            >
                                {label}
                            </Text>
