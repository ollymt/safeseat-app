	...
	return (
		...
		>
			<View style={[styles.container, { marginTop: 40 }]}>
				<View style={{ flexDirection: "row", alignItems: "center", marginBottom: 10, paddingRight: 0 }}>
					<Text style={[styles.pageHeader, { color: currentTheme.text, flex: 1 }]}>Everyone</Text>
				</View>
				...
				{selectedIndex === 0 ? (
					<View style={{ flex: 1 }}>
						<SectionList
							...
							contentContainerStyle={{ marginTop: 0, paddingBottom: 240 }}
							...
							renderSectionHeader={({ section: { title } }) => (
								<View style={[styles.sectionHeaderContainer, { backgroundColor: currentTheme.background }]}>
									<Text style={[styles.sectionHeaderTitle, { color: currentTheme.text }]}>
										{title}
									</Text>
								</View>
							)}
					...
					<View style={{ flexDirection: "row", gap: 10 }}>
						{selectedIndex === 0 ? (
							<>
								...
								<Host matchContents ignoreSafeArea="keyboard">
									<Button variant="outlined" modifiers={[controlSize("large"), buttonStyle("glass"), buttonBorderShape("circle")]} onPress={() => { setAddProfileVisible(true) }}>
										<Icon name={Icon.select({
											ios: "plus",
							...
							<>
								<View style={{ flex: 1 }} /> {/* Keeps the button pushed cleanly to the right side */}
								<Host matchContents ignoreSafeArea="keyboard">
									<Button variant="outlined" modifiers={[controlSize("large"), buttonStyle("glass"), buttonBorderShape("circle")]} onPress={() => { setAddProfileVisible(true) }}>
										<Icon name={Icon.select({
											ios: "plus",
