					...
					>
						<View>
							...
							<View style={{ borderRadius: 12, overflow: "hidden" }}>
								...
								<SettingPageItem name="Name" iconName={Icon.select({
									ios: "person.fill",
									android: import("@expo/material-symbols/person.xml")
								})} value={userName} />

								<SettingPageItem name="Email" iconName={Icon.select({
									ios: "at",
						...
						<View>
							...
							<View style={{ borderRadius: 12, overflow: "hidden" }}>
								...
								<SettingPageItem name="Height" iconName={Icon.select({
									ios: "lines.measurement.vertical",
									android: import("@expo/material-symbols/height.xml")
								})} value={height} />

								<SettingPageItem name="Weight" iconName={Icon.select({
									ios: "scalemass.fill",
								...
								<SettingPageItem name="Allergies" iconName={Icon.select({
									ios: "nosign",
							...
							<View style={{ gap: 20 }}>
								<View style={{ gap: 6 }}>
									...
									<View style={{ paddingHorizontal: 10, paddingVertical: 0 }}>
										<Text style={[styles.caption, { color: currentTheme.textSecondary }]}>Authorize real-time synchronization with secure cloud nodes.</Text>
									</View>
								</View>
								<View style={{ gap: 6 }}>
									<View style={{ borderRadius: 12, overflow: "hidden" }}>
									...
									<View style={{ paddingHorizontal: 10, paddingVertical: 0 }}>
										<Text style={[styles.caption, { color: currentTheme.textSecondary }]}>Automatic alert routing to nearest response center if unresponsive.</Text>
									</View>
								</View>
							</View>
						</View>
							...
							<View style={{ gap: 20 }}>
								...
								<View style={{ gap: 6 }}>
									<View style={{ borderRadius: 12, overflow: "hidden" }}>
										...
										})} isLast={true} destructive={true} />
									</View>
									<View style={{ paddingHorizontal: 10, paddingVertical: 0 }}>
										<Text style={[styles.caption, { color: currentTheme.textSecondary }]}>Permanently delete your account. This action cannot be undone.</Text>
									</View>
								</View>
							</View>
						</View>
